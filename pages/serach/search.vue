<template>
	<view class="content">
		...
		<view class="search-keyword">
			<scroll-view class="keyword-list-box" v-show="false" scroll-y>
			...
			<scroll-view class="keyword-box" v-show="!isShowKeywordList" scroll-y>
				<view class="keyword-block" v-if="oldKeywordList.length>0">
					...
					<view class="keyword">
						<view v-for="(keyword,index) in oldKeywordList" @click="search(keyword)" @tap="doSearch(keyword)" :key="index">{{keyword}}</view>
					</view>
				</view>
...
<script>
    ...
    // import GoodsListItem from '../../components/good-list/GoodsListItem.vue'
	export default {
		data() {
			return {
				flag:false,
		...
		methods: {
			...
			loadHotKeyword() {
				...
				this.hotKeywordList = ['鞋子', '鼠标', '显示器', '电脑主机', '键盘', '笔记本电脑', '鼠标', '床桌', '上衣'];
			},
			...
			request({
				url:"product/search?describe="+this.keyword,
				method:"POST",
				// data:{
				// 	describe:keyword
				// },
