  ...
  <view class="content">
    ...
    <view class="list">
      <view class="list-call">
        ...
        <input class="sl-input" v-model="user" type="text" maxlength="12" placeholder="用户名" />
      </view>
      <view class="list-call">
	  ...
	  <view class="list-call">
	    <image class="img" src="/static/shilu-login/2.png"></image>
	    <input class="sl-input" v-model="makepassword" type="text" maxlength="32" placeholder="确认密码" :makepassword="!showPassword" />
	    <!-- <image class="img" :src="showPassword?'/static/shilu-login/op.png':'/static/shilu-login/cl.png'" @tap="display"></image> -->
	  </view>
	  <view class="list-call">
	    <image class="img" src="/static/shilu-login/1.png"></image>
	    <input class="sl-input" v-model="phone" type="text" maxlength="11" placeholder="手机号" />
		  <view class="yzm"  @click="getcode">{{yanzhengma}}</view>
	  </view>
      <view class="list-call">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      bindLogin() {
		  if (this.password !== this.makepassword) {
		    uni.showToast({
		      icon: 'none',
		      title: '两次密码输入不一致'
		    });
